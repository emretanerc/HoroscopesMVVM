package com.etcmobileapps.burcyorumlari2020.ui.horoscopes
...
import com.etcmobileapps.burcyorumlari2020.model.HoroscopeModel
...
class HoroscopesAdapter(private val horoscopeList: List<HoroscopeModel>, private val onItemClicked: (HoroscopeModel) -> Unit) : RecyclerView.Adapter<HoroscopesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HoroscopesAdapter.ViewHolder, position: Int) {
